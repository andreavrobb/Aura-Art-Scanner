...
body[data-theme="light"] .stApp [data-testid="stSidebar"],
body[data-theme="light"] .stApp [data-testid="stSidebar"] > div:first-child,
html[data-theme="light"] .stApp [data-testid="stSidebar"],
html[data-theme="light"] .stApp [data-testid="stSidebar"] > div:first-child {
    background: rgba(255, 255, 255, 0.98) !important;
    background-color: rgba(255, 255, 255, 0.98) !important;
    border-right: 1px solid rgba(40, 40, 40, 0.08);
}

body[data-theme="light"] .stApp [data-testid="stSidebar"] [data-testid="stMarkdownContainer"],
body[data-theme="light"] .stApp [data-testid="stSidebar"] label,
body[data-theme="light"] .stApp [data-testid="stSidebar"] p,
body[data-theme="light"] .stApp [data-testid="stSidebar"] span,
body[data-theme="light"] .stApp [data-testid="stSidebar"] h1,
body[data-theme="light"] .stApp [data-testid="stSidebar"] h2,
body[data-theme="light"] .stApp [data-testid="stSidebar"] h3,
body[data-theme="light"] .stApp [data-testid="stSidebar"] h4,
body[data-theme="light"] .stApp [data-testid="stSidebar"] h5,
body[data-theme="light"] .stApp [data-testid="stSidebar"] h6,
body[data-theme="light"] .stApp [data-testid="stSidebar"] .stCaption,
body[data-theme="light"] .stApp [data-testid="stSidebar"] [data-testid="stExpander"] summary,
body[data-theme="light"] .stApp [data-testid="stSidebar"] [data-testid="stExpander"] details summary p,
html[data-theme="light"] .stApp [data-testid="stSidebar"] [data-testid="stMarkdownContainer"],
html[data-theme="light"] .stApp [data-testid="stSidebar"] label,
html[data-theme="light"] .stApp [data-testid="stSidebar"] p,
html[data-theme="light"] .stApp [data-testid="stSidebar"] span,
html[data-theme="light"] .stApp [data-testid="stSidebar"] h1,
html[data-theme="light"] .stApp [data-testid="stSidebar"] h2,
html[data-theme="light"] .stApp [data-testid="stSidebar"] h3,
html[data-theme="light"] .stApp [data-testid="stSidebar"] h4,
html[data-theme="light"] .stApp [data-testid="stSidebar"] h5,
html[data-theme="light"] .stApp [data-testid="stSidebar"] h6,
html[data-theme="light"] .stApp [data-testid="stSidebar"] .stCaption,
html[data-theme="light"] .stApp [data-testid="stSidebar"] [data-testid="stExpander"] summary,
html[data-theme="light"] .stApp [data-testid="stSidebar"] [data-testid="stExpander"] details summary p {
    color: #171717 !important;
}

body[data-theme="light"] .stApp [data-testid="stHeader"] button,
html[data-theme="light"] .stApp [data-testid="stHeader"] button {
    background: rgba(255, 251, 246, 0.96) !important;
    border: 1px solid rgba(177, 135, 67, 0.22) !important;
    color: #1f1f1f !important;
}

body[data-theme="light"] .stApp [data-testid="stSidebar"] [data-testid="stExpander"],
html[data-theme="light"] .stApp [data-testid="stSidebar"] [data-testid="stExpander"] {
    background: rgba(255, 255, 255, 0.98) !important;
    border-color: rgba(40, 40, 40, 0.12) !important;
}

body[data-theme="light"] .stApp [data-testid="stSidebar"] .sidebar-profile-card,
html[data-theme="light"] .stApp [data-testid="stSidebar"] .sidebar-profile-card {
    background: rgba(255, 255, 255, 0.98) !important;
    border: 1px solid rgba(40, 40, 40, 0.08) !important;
}

body[data-theme="light"] .stApp [data-testid="stSidebar"] .sidebar-profile-kicker,
html[data-theme="light"] .stApp [data-testid="stSidebar"] .sidebar-profile-kicker {
    background: rgba(242, 247, 243, 0.96) !important;
    border: 1px solid rgba(40, 40, 40, 0.08) !important;
    color: #171717 !important;
}

body[data-theme="light"] .stApp [data-testid="stSidebar"] .sidebar-profile-title,
body[data-theme="light"] .stApp [data-testid="stSidebar"] .sidebar-profile-copy,
body[data-theme="light"] .stApp [data-testid="stSidebar"] .sidebar-profile-focus,
html[data-theme="light"] .stApp [data-testid="stSidebar"] .sidebar-profile-title,
html[data-theme="light"] .stApp [data-testid="stSidebar"] .sidebar-profile-copy,
html[data-theme="light"] .stApp [data-testid="stSidebar"] .sidebar-profile-focus {
    color: #171717 !important;
}

body[data-theme="light"] .stApp [data-testid="stSidebar"] .sidebar-profile-focus,
html[data-theme="light"] .stApp [data-testid="stSidebar"] .sidebar-profile-focus {
    background: rgba(247, 249, 248, 0.98) !important;
    border: 1px solid rgba(40, 40, 40, 0.08) !important;
}

body[data-theme="light"] .stApp [data-testid="stHeader"] button svg,
body[data-theme="light"] .stApp [data-testid="stHeader"] button path,
body[data-theme="light"] .stApp [data-testid="stHeader"] button circle,
body[data-theme="light"] .stApp [data-testid="stHeader"] button line,
html[data-theme="light"] .stApp [data-testid="stHeader"] button svg,
html[data-theme="light"] .stApp [data-testid="stHeader"] button path,
html[data-theme="light"] .stApp [data-testid="stHeader"] button circle,
html[data-theme="light"] .stApp [data-testid="stHeader"] button line {
    fill: #1f1f1f !important;
    stroke: #1f1f1f !important;
    color: #1f1f1f !important;
}

body[data-theme="dark"] .stApp [data-testid="stSidebar"],
body[data-theme="dark"] .stApp [data-testid="stSidebar"] > div:first-child,
html[data-theme="dark"] .stApp [data-testid="stSidebar"],
html[data-theme="dark"] .stApp [data-testid="stSidebar"] > div:first-child {
    background: rgba(20, 23, 31, 0.97) !important;
    background-color: rgba(20, 23, 31, 0.97) !important;
    border-right: 1px solid rgba(255, 255, 255, 0.08);
}

body[data-theme="dark"] .stApp [data-testid="stSidebar"] [data-testid="stMarkdownContainer"],
body[data-theme="dark"] .stApp [data-testid="stSidebar"] label,
body[data-theme="dark"] .stApp [data-testid="stSidebar"] p,
body[data-theme="dark"] .stApp [data-testid="stSidebar"] span,
body[data-theme="dark"] .stApp [data-testid="stSidebar"] h1,
body[data-theme="dark"] .stApp [data-testid="stSidebar"] h2,
body[data-theme="dark"] .stApp [data-testid="stSidebar"] h3,
body[data-theme="dark"] .stApp [data-testid="stSidebar"] h4,
body[data-theme="dark"] .stApp [data-testid="stSidebar"] h5,
body[data-theme="dark"] .stApp [data-testid="stSidebar"] h6,
body[data-theme="dark"] .stApp [data-testid="stSidebar"] .stCaption,
body[data-theme="dark"] .stApp [data-testid="stSidebar"] [data-testid="stExpander"] summary,
body[data-theme="dark"] .stApp [data-testid="stSidebar"] [data-testid="stExpander"] details summary p,
html[data-theme="dark"] .stApp [data-testid="stSidebar"] [data-testid="stMarkdownContainer"],
html[data-theme="dark"] .stApp [data-testid="stSidebar"] label,
html[data-theme="dark"] .stApp [data-testid="stSidebar"] p,
html[data-theme="dark"] .stApp [data-testid="stSidebar"] span,
html[data-theme="dark"] .stApp [data-testid="stSidebar"] h1,
html[data-theme="dark"] .stApp [data-testid="stSidebar"] h2,
html[data-theme="dark"] .stApp [data-testid="stSidebar"] h3,
html[data-theme="dark"] .stApp [data-testid="stSidebar"] h4,
html[data-theme="dark"] .stApp [data-testid="stSidebar"] h5,
html[data-theme="dark"] .stApp [data-testid="stSidebar"] h6,
html[data-theme="dark"] .stApp [data-testid="stSidebar"] .stCaption,
html[data-theme="dark"] .stApp [data-testid="stSidebar"] [data-testid="stExpander"] summary,
html[data-theme="dark"] .stApp [data-testid="stSidebar"] [data-testid="stExpander"] details summary p {
    color: #f5f2ea !important;
}

body[data-theme="dark"] .stApp [data-testid="stSidebar"] [data-testid="stExpander"],
html[data-theme="dark"] .stApp [data-testid="stSidebar"] [data-testid="stExpander"] {
    background: rgba(29, 33, 43, 0.9) !important;
    border-color: rgba(255, 255, 255, 0.12) !important;
}

body[data-theme="dark"] .stApp [data-testid="stSidebar"] .sidebar-profile-card,
html[data-theme="dark"] .stApp [data-testid="stSidebar"] .sidebar-profile-card {
    background: rgba(29, 33, 43, 0.92) !important;
    border: 1px solid rgba(255, 255, 255, 0.1) !important;
}

body[data-theme="dark"] .stApp [data-testid="stSidebar"] .sidebar-profile-kicker,
html[data-theme="dark"] .stApp [data-testid="stSidebar"] .sidebar-profile-kicker {
    background: rgba(41, 56, 48, 0.94) !important;
    border: 1px solid rgba(140, 193, 158, 0.22) !important;
    color: #f5f2ea !important;
}

body[data-theme="dark"] .stApp [data-testid="stSidebar"] .sidebar-profile-title,
body[data-theme="dark"] .stApp [data-testid="stSidebar"] .sidebar-profile-copy,
body[data-theme="dark"] .stApp [data-testid="stSidebar"] .sidebar-profile-focus,
html[data-theme="dark"] .stApp [data-testid="stSidebar"] .sidebar-profile-title,
html[data-theme="dark"] .stApp [data-testid="stSidebar"] .sidebar-profile-copy,
html[data-theme="dark"] .stApp [data-testid="stSidebar"] .sidebar-profile-focus {
    color: #f5f2ea !important;
}
...
body[data-theme="dark"] .stApp [data-testid="stHeader"] button,
html[data-theme="dark"] .stApp [data-testid="stHeader"] button {
    background: rgba(28, 32, 42, 0.94) !important;
    border: 1px solid rgba(255, 255, 255, 0.16) !important;
    color: #f8f6f1 !important;
}

body[data-theme="dark"] .stApp [data-testid="stHeader"] button svg,
body[data-theme="dark"] .stApp [data-testid="stHeader"] button path,
body[data-theme="dark"] .stApp [data-testid="stHeader"] button circle,
body[data-theme="dark"] .stApp [data-testid="stHeader"] button line,
html[data-theme="dark"] .stApp [data-testid="stHeader"] button svg,
html[data-theme="dark"] .stApp [data-testid="stHeader"] button path,
html[data-theme="dark"] .stApp [data-testid="stHeader"] button circle,
html[data-theme="dark"] .stApp [data-testid="stHeader"] button line {
...
@media (prefers-color-scheme: dark) {
    body:not([data-theme]) .stApp [data-testid="stSidebar"],
    body:not([data-theme]) .stApp [data-testid="stSidebar"] > div:first-child,
    html:not([data-theme]) .stApp [data-testid="stSidebar"],
    html:not([data-theme]) .stApp [data-testid="stSidebar"] > div:first-child {
        background: rgba(20, 23, 31, 0.97) !important;
        background-color: rgba(20, 23, 31, 0.97) !important;
        border-right: 1px solid rgba(255, 255, 255, 0.08);
    }

    body:not([data-theme]) .stApp [data-testid="stSidebar"] [data-testid="stMarkdownContainer"],
    body:not([data-theme]) .stApp [data-testid="stSidebar"] label,
    body:not([data-theme]) .stApp [data-testid="stSidebar"] p,
    body:not([data-theme]) .stApp [data-testid="stSidebar"] span,
    body:not([data-theme]) .stApp [data-testid="stSidebar"] h1,
    body:not([data-theme]) .stApp [data-testid="stSidebar"] h2,
    body:not([data-theme]) .stApp [data-testid="stSidebar"] h3,
    body:not([data-theme]) .stApp [data-testid="stSidebar"] h4,
    body:not([data-theme]) .stApp [data-testid="stSidebar"] h5,
    body:not([data-theme]) .stApp [data-testid="stSidebar"] h6,
    body:not([data-theme]) .stApp [data-testid="stSidebar"] .stCaption,
    body:not([data-theme]) .stApp [data-testid="stSidebar"] [data-testid="stExpander"] summary,
    body:not([data-theme]) .stApp [data-testid="stSidebar"] [data-testid="stExpander"] details summary p,
    html:not([data-theme]) .stApp [data-testid="stSidebar"] [data-testid="stMarkdownContainer"],
    html:not([data-theme]) .stApp [data-testid="stSidebar"] label,
    html:not([data-theme]) .stApp [data-testid="stSidebar"] p,
    html:not([data-theme]) .stApp [data-testid="stSidebar"] span,
    html:not([data-theme]) .stApp [data-testid="stSidebar"] h1,
    html:not([data-theme]) .stApp [data-testid="stSidebar"] h2,
    html:not([data-theme]) .stApp [data-testid="stSidebar"] h3,
    html:not([data-theme]) .stApp [data-testid="stSidebar"] h4,
    html:not([data-theme]) .stApp [data-testid="stSidebar"] h5,
    html:not([data-theme]) .stApp [data-testid="stSidebar"] h6,
    html:not([data-theme]) .stApp [data-testid="stSidebar"] .stCaption,
    html:not([data-theme]) .stApp [data-testid="stSidebar"] [data-testid="stExpander"] summary,
    html:not([data-theme]) .stApp [data-testid="stSidebar"] [data-testid="stExpander"] details summary p {
        color: #f5f2ea !important;
    }

    body:not([data-theme]) .stApp [data-testid="stHeader"] button,
    html:not([data-theme]) .stApp [data-testid="stHeader"] button {
        background: rgba(28, 32, 42, 0.94) !important;
        border: 1px solid rgba(255, 255, 255, 0.16) !important;
        color: #f8f6f1 !important;
    }

    body:not([data-theme]) .stApp [data-testid="stSidebar"] .sidebar-profile-card,
    html:not([data-theme]) .stApp [data-testid="stSidebar"] .sidebar-profile-card {
        background: rgba(29, 33, 43, 0.92) !important;
        border: 1px solid rgba(255, 255, 255, 0.1) !important;
    }

    body:not([data-theme]) .stApp [data-testid="stSidebar"] .sidebar-profile-kicker,
    html:not([data-theme]) .stApp [data-testid="stSidebar"] .sidebar-profile-kicker {
        background: rgba(41, 56, 48, 0.94) !important;
        border: 1px solid rgba(140, 193, 158, 0.22) !important;
        color: #f5f2ea !important;
    }

    body:not([data-theme]) .stApp [data-testid="stSidebar"] .sidebar-profile-title,
    body:not([data-theme]) .stApp [data-testid="stSidebar"] .sidebar-profile-copy,
    body:not([data-theme]) .stApp [data-testid="stSidebar"] .sidebar-profile-focus,
    html:not([data-theme]) .stApp [data-testid="stSidebar"] .sidebar-profile-title,
    html:not([data-theme]) .stApp [data-testid="stSidebar"] .sidebar-profile-copy,
    html:not([data-theme]) .stApp [data-testid="stSidebar"] .sidebar-profile-focus {
        color: #f5f2ea !important;
    }
    ...
    body:not([data-theme]) .stApp [data-testid="stHeader"] button svg,
    body:not([data-theme]) .stApp [data-testid="stHeader"] button path,
    body:not([data-theme]) .stApp [data-testid="stHeader"] button circle,
    body:not([data-theme]) .stApp [data-testid="stHeader"] button line,
    html:not([data-theme]) .stApp [data-testid="stHeader"] button svg,
    html:not([data-theme]) .stApp [data-testid="stHeader"] button path,
    html:not([data-theme]) .stApp [data-testid="stHeader"] button circle,
    html:not([data-theme]) .stApp [data-testid="stHeader"] button line {
        fill: #f8f6f1 !important;
        stroke: #f8f6f1 !important;
        color: #f8f6f1 !important;
    }
